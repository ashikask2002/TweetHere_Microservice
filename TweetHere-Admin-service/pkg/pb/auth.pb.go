...
var file_pkg_pb_auth_proto_rawDesc = []byte{
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0x9a, 0x01,
...
var file_pkg_pb_auth_proto_depIdxs = []int32{
	...
	0, // 2: admin.AuthService.AdminSignUp:input_type -> admin.AdminSignupRequest
	3, // 3: admin.AuthService.AdminLogin:input_type -> admin.AdminLoginRequest
	1, // 4: admin.AuthService.AdminSignUp:output_type -> admin.AdminSignupResponse
	4, // 5: admin.AuthService.AdminLogin:output_type -> admin.AdminLoginResponse
